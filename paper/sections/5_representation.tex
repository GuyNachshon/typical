...
is $\dqsh$ (\Cref{def:deltaq}). Every candidate-blind variant we trained lands within $\pm.03$ of zero
and four of the six are \emph{below} it, against $+.102$ for the teacher they were distilled from: the
real question buys them nothing, or nearly nothing, over a shuffled unrelated one with the candidate
set held fixed. Their above-chance accuracy of .12--.17 is candidate-set priors baked into the corpus.
Two variants (\texttt{z1} at $+.023$, \texttt{zr} at $-.026$) fall just outside the $\pm.02$
indistinguishable-from-zero band of \Cref{sec:experiments:deltaq} in opposite directions, which is what
1{,}200 items buys; the claim the figure supports is the separation from the teacher, not that any
individual student is exactly zero.
...
\begin{figure}[t]
  ...
  \Cref{sec:experiments:deltaq}). All six candidate-blind variants sit at or within .006 of that band
  regardless of head capacity, set conditioning, objective, or tap depth. The letter-logit readout, the
